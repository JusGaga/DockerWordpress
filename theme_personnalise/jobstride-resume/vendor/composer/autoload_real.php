...
class Luzuk_Jobstride_Resume_ComposerAutoloaderInit75f95ca3778976eb5c1bf35fe42ac3d4
{
    private static $loader;

    public static function luzuk_jobstride_resume_loadClassLoader($class)
    {
    ...
    public static function luzuk_jobstride_resume_getLoader()
    {
        if (null !== self::$loader) {
            return self::$loader;
        }
