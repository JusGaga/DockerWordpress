...
class Luzuk_Jobstride_Resume_Loader {
	/**
	 * Array of loaders.
	 *
	 * @since  1.0.0
	 ...
	 * @return void
	 */
	public function luzuk_jobstride_resume_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function luzuk_jobstride_resume_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function luzuk_jobstride_resume_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function luzuk_jobstride_resume_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->luzuk_jobstride_resume_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function luzuk_jobstride_resume_load( $class ) {
