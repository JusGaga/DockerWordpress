...
if ( ! class_exists( 'Luzuk_Jobstride_Resume_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Luzuk_Jobstride_Resume_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Luzuk_Jobstride_Resume_WPTT_WebFont_Loader( $url );
